(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/api'), require('@angular/router'), require('primeng-lts/ripple')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/megamenu', ['exports', '@angular/core', '@angular/common', 'primeng-lts/api', '@angular/router', 'primeng-lts/ripple'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].megamenu = {}), global.ng.core, global.ng.common, global['primeng-lts'].api, global.ng.router, global['primeng-lts'].ripple));
