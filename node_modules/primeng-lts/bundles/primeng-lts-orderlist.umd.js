(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/button'), require('primeng-lts/api'), require('primeng-lts/dom'), require('primeng-lts/utils'), require('primeng-lts/ripple')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/orderlist', ['exports', '@angular/core', '@angular/common', 'primeng-lts/button', 'primeng-lts/api', 'primeng-lts/dom', 'primeng-lts/utils', 'primeng-lts/ripple'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].orderlist = {}), global.ng.core, global.ng.common, global['primeng-lts'].button, global['primeng-lts'].api, global['primeng-lts'].dom, global['primeng-lts'].utils, global['primeng-lts'].ripple));
